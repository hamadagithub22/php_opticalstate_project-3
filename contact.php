...
if(isset($_POST['submit'])){
  ...
  $insert_query = "INSERT INTO `messages`(`id`, `name`, `email`, `phone`,  `message`) VALUES (null,'$name','$email',,'$phone','$message')";
  $insert = mysqli_query($con, $insert_query);
  if($insert){
    $message = "your message is send'it seccessful";
